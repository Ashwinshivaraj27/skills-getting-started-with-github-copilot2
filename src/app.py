...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team and play weekly matches",
        "schedule": "Practice: Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swim Club": {
        "description": "Train in competitive swimming and improve techniques",
        "schedule": "Mondays, Wednesdays, Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "mia@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and mixed media under guidance",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["sophia@mergington.edu", "noah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and script development for plays",
    ...
    "Science Club": {
        "description": "Conduct experiments, research projects, and science fairs",
